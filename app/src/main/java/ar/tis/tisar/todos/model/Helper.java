...
package ar.tis.tisar.todos.model;
...
public class Helper {
    ...
    public static int getDeadlineColor(Context context, TodoTask.DeadlineColors color) {
        switch (color) {
            case RED:
    ...
    public static String priority2String(Context context, TodoTask.Priority prio) {
