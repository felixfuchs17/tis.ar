...
package ar.tis.tisar.todos.model.database.tables;
...
public class TTodoTask {
    ...
    // TAG
//    private static final String TAG = org.secuso.privacyfriendlytodolist.model.database.tables.TTodoList.class.getSimpleName();
