...
public class TodoTasksFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private TodoActivity containingActivity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        containingActivity = (TodoActivity) getActivity();
        ...
        if(selectedListID >= 0) {
            currentList = containingActivity.getListByID(selectedListID); // TodoActivity was started after a notification click
